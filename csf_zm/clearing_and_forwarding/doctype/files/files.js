...
*/
    ...
    /*    after_save: function (frm) {
            ...
            if (frm.doc.import_transit || frm.doc.import_local) {
                ...
                frappe.call({
                    method: "csf_zm.clearing_and_forwarding.doctype.import.import.create_import",
                    freeze: true,
                    args: {
            ...
            } else if (frm.doc.export_transit || frm.doc.export_local) //If export is selected
            {
                ...
                frappe.call({
                    method: "csf_zm.clearing_and_forwarding.doctype.export.export.create_export",
                    freeze: true,
                    args: {
            ...
            {
                frappe.call({
                    method: "csf_zm.clearing_and_forwarding.doctype.border_clearance.border_clearance.create_border_clearance",
                    freeze: true,
                    args: {
    ...
    after_save: function (frm) {
        ...
        } else if (frm.doc.requested_service == "Border Processing") //If border processing is selected
        {
            ...
            frappe.call({
                method: "csf_zm.clearing_and_forwarding.doctype.border_processing.border_processing.create_border_processing",
                freeze: true,
                args: {
    ...
    validate_close: function (frm) {
        ...
        if (frm.doc.requested_service == "Importation-Transit" || frm.doc.requested_service == "Importation-Local") {
            ...
            frappe.call({
                method: "csf_zm.clearing_and_forwarding.doctype.import.import.check_import_status",
                freeze: true,
                args: {
            ...
            frappe.call({
                method: "csf_zm.clearing_and_forwarding.doctype.export.export.check_export_status",
                freeze: true,
                args: {
                    //import_reference: frm.import_reference,
                    file_number: frm.docname
    ...
    make_sales_invoice: function () {
        frappe.model.open_mapped_doc({
            ...
            method: "csf_zm.clearing_and_forwarding.doctype.files.files.make_sales_invoice",
            frm: cur_frm,
    ...
    make_purchase_invoice: function () {
        frappe.model.open_mapped_doc({
            method: "csf_zm.clearing_and_forwarding.doctype.files.files.make_purchase_invoice",
            frm: cur_frm
        })
    },
