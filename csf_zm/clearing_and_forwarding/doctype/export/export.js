...
frappe.ui.form.on('Export', {
	...
	download_tra_loading_list: function(frm){
		window.open("/api/method/csf_zm.clearing_and_forwarding.doctype.export.export.download_ticts_loading_list?args=test1");
	},
    ...
    booking_cancellation:function(frm){
        	frappe.call({
					method: "csf_zm.clearing_and_forwarding.doctype.container.container.remove_booking",
					args: {
