...
# 	'Salary Slip': 'csf_zm.overrides.csftz_SalarySlip'
# }
...
# app_include_css = "/assets/csf_zm/css/csf_zm.css"
# app_include_js = "/assets/csf_zm/js/csf_zm.js"
app_include_js = [
    "/assets/js/select_dialog.min.js",
    "/assets/js/to_console.min.js",
    "/assets/js/jobcards.min.js",
    "/assets/csf_zm/node_modules/vuetify/dist/vuetify.js",
]

app_include_css = "/assets/csf_zm/css/theme.css"
web_include_css = "/assets/csf_zm/css/theme.css"
# include js, css files in header of web template
# web_include_css = "/assets/csf_zm/css/csf_zm.css"
# web_include_js = "/assets/csf_zm/js/csf_zm.js"
...
doctype_js = {
    "Payment Entry": "csf_zm/payment_entry.js",
    "Sales Invoice": "csf_zm/sales_invoice.js",
    "Sales Order": "csf_zm/sales_order.js",
    "Delivery Note": "csf_zm/delivery_note.js",
    "Customer": "csf_zm/customer.js",
    "Supplier": "csf_zm/supplier.js",
    "Stock Entry": "csf_zm/stock_entry.js",
    "Account": "csf_zm/account.js",
    "Warehouse": "csf_zm/warehouse.js",
    "Company": "csf_zm/company.js",
    "Stock Reconciliation": "csf_zm/stock_reconciliation.js",
    "Fees": "csf_zm/fees.js",
    "Program Enrollment Tool": "csf_zm/program_enrollment_tool.js",
    "Purchase Invoice": "csf_zm/purchase_invoice.js",
    "Quotation": "csf_zm/quotation.js",
    "Purchase Receipt": "csf_zm/purchase_receipt.js",
    "Purchase Order": "csf_zm/purchase_order.js",
    "Student Applicant": "csf_zm/student_applicant.js",
    "Bank Reconciliation": "csf_zm/bank_reconciliation.js",
    "Program Enrollment": "csf_zm/program_enrollment.js",
    "Payroll Entry": "csf_zm/payroll_entry.js",
    "Salary Slip": "csf_zm/salary_slip.js",
    "Landed Cost Voucher": "csf_zm/landed_cost_voucher.js",
}
...
# get_website_user_home_page = "csf_zm.utils.get_home_page"
...
# before_install = "csf_zm.install.before_install"
# after_install = "csf_zm.install.after_install"

# Desk Notifications
# ------------------
# See frappe.core.notifications.get_notification_config

# notification_config = "csf_zm.notifications.get_notification_config"
...
doc_events = {
    "Open Invoice Exchange Rate Revaluation": {
        "validate": "csf_zm.custom_api.getInvoiceExchangeRate"
    },
    "Sales Invoice": {
        "on_submit": [
            "csf_zm.custom_api.validate_net_rate",
            "csf_zm.custom_api.create_delivery_note",
            "csf_zm.custom_api.check_submit_delivery_note",
            "csf_zm.custom_api.make_withholding_tax_gl_entries_for_sales",
        ],
        "validate": [
            "csf_zm.custom_api.check_validate_delivery_note",
            "csf_zm.custom_api.validate_items_remaining_qty",
            "csf_zm.custom_api.calculate_price_reduction",
        ],
        "before_cancel": "csf_zm.custom_api.check_cancel_delivery_note",
    },
    "Delivery Note": {
        "on_submit": "csf_zm.custom_api.update_delivery_on_sales_invoice",
        "before_cancel": "csf_zm.custom_api.update_delivery_on_sales_invoice",
    },
    "Account": {
        "on_update": "csf_zm.custom_api.create_indirect_expense_item",
        "after_insert": "csf_zm.custom_api.create_indirect_expense_item",
    },
    "Purchase Invoice": {
        "on_submit": "csf_zm.custom_api.make_withholding_tax_gl_entries_for_purchase",
    },
    "Fees": {
        "before_insert": "csf_zm.custom_api.set_fee_abbr",
        "after_insert": "csf_zm.bank_api.set_callback_token",
        "on_submit": "csf_zm.bank_api.invoice_submission",
        "before_cancel": "csf_zm.custom_api.on_cancel_fees",
    },
    "Program Enrollment": {
        "onload": "csf_zm.csftz_hooks.program_enrollment.create_course_enrollments_override",
        "refresh": "csf_zm.csftz_hooks.program_enrollment.create_course_enrollments_override",
        "reload": "csf_zm.csftz_hooks.program_enrollment.create_course_enrollments_override",
        "before_submit": "csf_zm.csftz_hooks.program_enrollment.validate_submit_program_enrollment",
    },
    "*": {
        "validate": ["csf_zm.csf_zm.doctype.visibility.visibility.run_visibility"],
        "onload": ["csf_zm.csf_zm.doctype.visibility.visibility.run_visibility"],
        "before_insert": ["csf_zm.csf_zm.doctype.visibility.visibility.run_visibility"],
        "after_insert": ["csf_zm.csf_zm.doctype.visibility.visibility.run_visibility"],
        "before_naming": ["csf_zm.csf_zm.doctype.visibility.visibility.run_visibility"],
        "before_change": ["csf_zm.csf_zm.doctype.visibility.visibility.run_visibility"],
        "before_update_after_submit": [
            "csf_zm.csf_zm.doctype.visibility.visibility.run_visibility"
        ],
        "before_validate": [
            "csf_zm.csf_zm.doctype.visibility.visibility.run_visibility"
        ],
        "before_save": ["csf_zm.csf_zm.doctype.visibility.visibility.run_visibility"],
        "on_update": ["csf_zm.csf_zm.doctype.visibility.visibility.run_visibility"],
        "before_submit": ["csf_zm.csf_zm.doctype.visibility.visibility.run_visibility"],
        "autoname": ["csf_zm.csf_zm.doctype.visibility.visibility.run_visibility"],
        "on_cancel": ["csf_zm.csf_zm.doctype.visibility.visibility.run_visibility"],
        "on_trash": ["csf_zm.csf_zm.doctype.visibility.visibility.run_visibility"],
        "on_submit": ["csf_zm.csf_zm.doctype.visibility.visibility.run_visibility"],
        "on_update_after_submit": [
            "csf_zm.csf_zm.doctype.visibility.visibility.run_visibility"
        ],
        "on_change": ["csf_zm.csf_zm.doctype.visibility.visibility.run_visibility"],
    },
    "Stock Entry": {
        "validate": "csf_zm.custom_api.calculate_total_net_weight",
    },
    "Student Applicant": {
        "on_update_after_submit": "csf_zm.csftz_hooks.student_applicant.make_student_applicant_fees",
    },
    "Custom DocPerm": {
        "validate": "csf_zm.csftz_hooks.custom_docperm.grant_dependant_access",
    },
}
...
scheduler_events = {
    ...
    "cron": {
        "0 */6 * * *": [
            "csf_zm.csf_zm.doctype.parking_bill.parking_bill.check_bills_all_vehicles",
            "csf_zm.csf_zm.doctype.vehicle_fine_record.vehicle_fine_record.check_fine_all_vehicles",
        ],
        "*/15 * * * *": [
            "csf_zm.csftz_hooks.items_revaluation.process_incorrect_balance_qty"
        ],
        # Routine for every day 3:30am at night
        "30 3 * * *": [
            "csf_zm.custom_api.auto_close_dn",
        ],
    },
    "daily": [
        "csf_zm.custom_api.create_delivery_note_for_all_pending_sales_invoice",
        "csf_zm.csf_zm.doctype.visibility.visibility.trigger_daily_alerts",
        "csf_zm.bank_api.reconciliation",
    ],
    # "hourly": [
    # 	"csf_zm.tasks.hourly"
    # ],
    "weekly": [
        "csf_zm.custom_api.make_stock_reconciliation_for_all_pending_material_request"
    ],
    "monthly": [
        # "csf_zm.tasks.monthly",
        "csf_zm.csf_zm.doctype.tz_insurance_cover_note.tz_insurance_cover_note.update_covernote_docs"
    ],
}

jenv = {"methods": ["generate_qrcode:csf_zm.custom_api.generate_qrcode"]}

# Testing
# -------

# before_tests = "csf_zm.install.before_tests"

# Overriding Whitelisted Methods
# ------------------------------
#
override_whitelisted_methods = {
    "frappe.desk.query_report.get_script": "csf_zm.csftz_hooks.query_report.get_script"
}
