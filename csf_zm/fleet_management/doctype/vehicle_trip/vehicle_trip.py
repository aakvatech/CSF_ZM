...
from csf_zm.after_sales_services.doctype.requested_payments.requested_payments import (
    validate_requested_funds,
)


class VehicleTrip(Document):
    from csf_zm.after_sales_services.doctype.reference_payment_table.reference_payment_table import (
        update_child_table,
    )
